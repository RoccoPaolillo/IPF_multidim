...
class SynthPopGUI(tk.Tk):
    ...
    def __init__(self):
        ...
        # --- Filter string ---
        tk.Label(self, text="Filter (e.g.all or gender:male,age:3060,hf:no)").grid(
            row=1, column=0, sticky="w", padx=5, pady=5
        )
        self.filter_entry = tk.Entry(self, width=70)
        self.filter_entry.insert(0, "all")
        self.filter_entry.grid(row=1, column=1, padx=5, pady=5, sticky="we", columnspan=2)
        ...
        tk.Radiobutton(self, text="aggregate", variable=self.display_var, value="aggregate").grid(
            row=2, column=1, sticky="w", padx=90
        )
        ...
        self.validate_check.grid(row=3, column=1, sticky="w")

        tk.Label(self, text="Basename:").grid(row=3, column=1, sticky="w", padx=(220, 0))
        self.validate_base_entry = tk.Entry(self, width=18)
        self.validate_base_entry.insert(0, "validation")
        self.validate_base_entry.grid(row=3, column=1, sticky="w", padx=(290, 0))
        ...
        self.synth_total_entry.grid(row=4, column=1, sticky="w")
        tk.Label(self, text="(leave blank to use inferred total)").grid(
            row=4, column=1, sticky="w", padx=(180, 0)
        )
        ...
        self.output_entry.grid(row=5, column=1, padx=5, pady=5, sticky="we")
